...
#define WEBS_DEFAULT_HOME		T("index.htm") /* Default home page */
...
#ifdef LITTLEFOOT
#define WEBS_HEADER_BUFINC 		256			/* Header buffer size */
#define WEBS_ASP_BUFINC			256			/* Asp expansion increment */
...
#define WEBS_BUFSIZE			512			/* websWrite max output string */
#define WEBS_MAX_HEADER			(2 * 1024)	/* Sanity check header */
#define WEBS_MAX_URL			512		    /* Maximum URL size for sanity */
#define WEBS_SOCKET_BUFSIZ		256			/* Bytes read from socket */
#endif
