...
// RTU function
extern const luaL_Reg rtu_di_funcs[];
extern const luaL_Reg rtu_do_funcs[];
extern const luaL_Reg rtu_sys_funcs[];
extern const luaL_Reg lua_uart_funcs[];
// 
...
// RTU function
  {LUA_RTU_DI_LIBNAME, rtu_di_funcs, NULL}, 
  {LUA_RTU_DO_LIBNAME, rtu_do_funcs, NULL}, 
  {LUA_RTU_SYS_LIBNAME, rtu_sys_funcs, NULL}, 
  {LUA_RTU_UART_LIBNAME, lua_uart_funcs, NULL}, 
//
#endif
  {NULL, NULL, NULL}
};
