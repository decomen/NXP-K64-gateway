...
typedef enum {
	        MSG_TEST_ONLINE_STATUS = 0x00,          //褰撳墠杩愯鐘舵�? 鐢卞熀鏉块殢鏃朵笂鎶?
            
            MSG_TEST_ON_OFF = 0xd0,                 //鐢靛帇娴嬭瘯
            MSG_TEST_RTC = 0xd1,                     //RTC娴嬭瘯
            MSG_TEST_SPIFLASH = 0xd2,                //SPI Flash 娴嬭瘯
            MSG_TEST_SDCARD = 0xd3,                 //SPI Flash 娴嬭瘯
            MSG_TEST_GPRS = 0xd4,
            MSG_TEST_ZIGBEE = 0xd5,
            MSG_TEST_TTLInput = 0xd6,              //TTLInput 娴嬭瘯
            MSG_TEST_LORA = 0xd7,
            MSG_TEST_NET = 0xd8,
            MSG_TEST_ADC = 0xd9,
            MSG_TEST_VOL = 0xda,
            ...
            MSG_TEST_GET_TEST_ADC = 0xdf, //获取校验过后ADC的校准值
                   
            MSG_TEST_SET_PRODUCT_INFO = 0xe0,       //璁剧疆浜у搧淇℃伅, 鎵�鏈夋祴璇曢�夐」閫氳繃鍚庡啀杩涜鍑哄巶璁剧疆
            MSG_TEST_GET_PRODUCT_INFO = 0xe1,       //鑾峰彇浜у搧淇℃伅, 鍚庢湡浣跨敤
