...
static void _des_main_ks( unsigned long SK[32], unsigned char key[8] )
{
	int i;
	unsigned long X, Y, T;
...
static void _des_crypt( unsigned long SK[32],unsigned char input[8],unsigned char output[8] )
{
	unsigned long X, Y, T;
