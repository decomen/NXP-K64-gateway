...
{
    if( !board_cfg_read( XFER_UART_CFG_OFS, &g_xfer_uart_cfgs[0], sizeof(g_xfer_uart_cfgs) ) ) {
...
{
    if( !board_cfg_write( XFER_UART_CFG_OFS, &g_xfer_uart_cfgs[0], sizeof(g_xfer_uart_cfgs) ) ) {
