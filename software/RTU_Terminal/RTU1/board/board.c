...
*/
    ...
    rt_pin_mode(BOARD_UART_SWITCH, PIN_MODE_OUTPUT);
    rt_pin_write(BOARD_UART_SWITCH, PIN_HIGH);
...
{
    rt_pin_mode(BOARD_UART_SWITCH, PIN_MODE_OUTPUT);
    rt_pin_write(BOARD_UART_SWITCH, PIN_LOW);

    rt_pin_mode(BOARD_UART_0_EN, PIN_MODE_INPUT);
    rt_pin_mode(BOARD_UART_1_EN, PIN_MODE_INPUT);
    rt_pin_mode(BOARD_UART_4_EN, PIN_MODE_INPUT);
    rt_pin_mode(BOARD_UART_5_EN, PIN_MODE_INPUT);
